...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'jira_bugs_clone_server';
    ...
    'jhipster.mail.from' = 'jira_bugs_clone_server@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'jira_bugs_clone_server API';
    'jhipster.swagger.description' = 'jira_bugs_clone_server API documentation';
    ...
    'eureka.instance.appname' = 'jira_bugs_clone_server';
    'eureka.instance.instanceId' = 'jira_bugs_clone_server:${random.value}';
    ...
    'cloud.config.name' = 'jira_bugs_clone_server';
